...
const Footerbar = () => {
    ...
    return (
        <div className={`${step === 5 ? 'hidden ' : 'flex '}footerbar bg-white w-full fixed lg:static bottom-0 left-0 p-3 lg:pb-0 lg:mt-auto lg:px-12  ${step === 1 ? ' justify-end ' : 'justify-between'}  items-center`}>
