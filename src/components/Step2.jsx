...
const Step2 = () => {
    ...
    return (
        <div className='step1 bg-white lg:w-[80%] rounded-md absolute  top-[-13%] lg:top-0 p-4 m-4 lg:m-0'>
            ...
            <div className="plan-container space-y-4 lg:space-y-8 mt-4 ">
                <div className='space-y-4 lg:space-y-0 lg:space-x-3 lg:flex'>
                    <div className="plan-card cursor-pointer flex w-full lg:h-48 lg:flex-col items-center lg:items-start space-x-5 lg:space-x-0  border-2 border-Lightgray p-4 rounded-md">
                    ...
                    <div className="plan-card cursor-pointer flex w-full lg:flex-col items-center lg:items-start space-x-5 lg:space-x-0 border-2 border-Lightgray p-4 rounded-md">
                ...
                <div className='flex justify-center items-center space-x-6 p-3 mt-auto bg-Lightgray rounded-lg'>
                    ...
                    <label className="inline-flex  relative items-center cursor-pointer">
                        <input type="checkbox" onChange={() => { setMonthly(!monthly) }} value="" className="sr-only peer" />
